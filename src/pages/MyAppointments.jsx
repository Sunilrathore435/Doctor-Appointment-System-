            ...
            <div>
             <img className='w-32 bg-indigo-50' src={item.docData.image} alt="" />
              ...
              <div className='flex flex-col gap-2 justify-end'>
                ...
                {/* {!item.cancelled && !item.payment && !item.isCompleted && <button  className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border hover:bg-primary hover:text-white transition-all duration-300'>Pay Online</button> } */}
